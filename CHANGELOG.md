...
* **gen:** use more restrictive version range for a3-component ([19698973](http://github.com/DaftMonk/generator-angular-fullstack/commit/196989730c8922fa5e1dc9caa45eb85052535e30))
...
* **gen:**
    ...
    * Add endpoint generator to a3, generates model / route / controller / test / socket updates
...
* **gen:** 
  * Added `a3:openshift` generator, for deploying your app to OpenShift
  * Added `a3:heroku` generator, which improves upon the former `:deploy` generator for deploying to Heroku
...
* The `a3:deploy` generator is deprecated. Instead use `a3:heroku` or `a3:openshift`.
...
Continue to use a3 route and view sub-generators.
